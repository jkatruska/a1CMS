...
<div class="form">
	<div class="header_form">
                ...
                <p class="update_form_label">Poschodie</p>
                <p class="update_form_label">Vložiť obrázok</p>
     </div>
    <form action="upload_business.php" method="post" enctype="multipart/form-data">
    	<input type="text" name="nazov" class="input">
        <input type="text" name="hover_cislo" class="input">
        <input type="text" name="hover_mail" class="input">
        <input type="text" name="hover_web" class="input">
        ...
        <textarea name="popis" class="popis"></textarea>
        <input type="file" name="img_base" id="fileToUpload"  class="custom-file-input-add change">
        <input type="submit" value="nahrať" name="submit" id="submit-add">
    </form>
