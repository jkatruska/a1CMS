<?php
	...
	$sql = "UPDATE business SET nazov='$nazov',hover_cislo='$hover_cislo',hover_mail='$hover_mail',hover_web='$hover_web',popis='$popis',img_base='$target_file',poschodie='$poschodia' ,miestnost='$miestnosti' WHERE id='$id'";
